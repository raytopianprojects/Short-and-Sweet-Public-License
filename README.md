...
5. You like the idea of building a community around editing and sharing each other's works. Just saying modding communities can make a game or any project for that matter last far longer than it should have. Look at Minecraft, Skyrim, and Hearts of Iron 4 as examples.
...
Permission is granted to anyone to use this Work for any purpose, including commercial applications, and to alter it, and redistribute it freely, and to use this Work, subject to the following restrictions:  
...
2. If you redistribute this Work or run a network service that uses this Work you must, reasonably, provide easily accessible URL(s) or link(s) to where anyone can freely download, in its preferred version for altering, this Work. 

3. You must, reasonably, provide an easily accessible URL or link, alongside this Work, to this license.  
